...
public class CheckCodeUtil {
    ...
    /**
     * Output a random verification code image stream, and return the verification code value
     *
     * @param width
     * @param height
     * @param os
     ...
     * (in the form of a picture, which is used less)
     *
     * @param w
     * @param h
     * @param outputFile
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        //Create a color collection, using the classes under the java.awt package
